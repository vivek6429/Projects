...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "";//mail id in base64
        const char* EMAILBASE64_PASSWORD = "";//passwoord in base 64
        const char* FROM = "***your_email***@gmail.com";//this a fied to show from
